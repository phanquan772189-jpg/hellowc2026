...
export default function PrivacyPolicyPage() {
  return (
    ...
    >
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">1. Phạm vi thu thập dữ liệu</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">2. Mục đích sử dụng</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">3. Cookie và công nghệ tương tự</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">4. Nguồn dữ liệu bên thứ ba</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">5. Thời gian lưu trữ</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">6. Quyền của người dùng</h2>
        <p className="mt-3">
