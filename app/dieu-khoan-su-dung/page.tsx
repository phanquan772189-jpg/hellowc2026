...
export default function TermsPage() {
  return (
    ...
    >
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">1. Tính chất thông tin</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">2. Giới hạn trách nhiệm</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">3. Hành vi sử dụng bị cấm</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">4. Quyền chỉnh sửa nội dung</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">5. Liên kết ngoài</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-black tracking-normal text-white">6. Hiệu lực</h2>
        <p className="mt-3">
