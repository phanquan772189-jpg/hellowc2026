...
function CustomTooltip({
  ...
  return (
    <div className="rounded-lg border border-white/15 bg-slate-900/95 px-3 py-2.5 shadow-xl backdrop-blur-sm">
...
export default function GoalTimeChart({
  ...
  if (totalGoals === 0) {
    return (
      <div className="flex min-h-[140px] items-center justify-center rounded-lg border border-white/10 bg-white/[0.03] text-sm text-slate-400">
